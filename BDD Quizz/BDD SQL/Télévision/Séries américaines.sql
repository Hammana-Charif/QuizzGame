...
-- [ Ça se bouscule au pays des séries US ]
...
INSERT INTO `openquizzdb` VALUES (null, 'Séries américaines', 'Quelle est la race du chien de Columbo, l\'inspecteur très obstiné et perspicace de la télévision ?', 'Basset', 'Beagle', 'Bichon', 'Barbet', 'Expert', 'Interrompue en 1978, la série télévisée Columbo a été ressuscitée en 1989, toujours avec Peter Falk dans le rôle principal.', 'Columbo');
